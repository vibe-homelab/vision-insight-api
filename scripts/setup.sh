...
echo ""
echo "  # VLM (fast)"
echo "  python -c \"from mlx_vlm import load; load('mlx-community/Qwen3-VL-4B-Instruct-4bit')\""
echo ""
echo "  # VLM (best quality)"
echo "  python -c \"from mlx_vlm import load; load('mlx-community/Qwen3-VL-8B-Instruct-4bit')\""
echo ""
