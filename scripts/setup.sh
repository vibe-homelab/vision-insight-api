...
echo ""
echo "  # VLM (fast)"
echo "  python -c \"from mlx_vlm import load; load('mlx-community/Qwen3.5-4B-MLX-4bit')\""
echo ""
echo "  # VLM (best quality)"
echo "  python -c \"from mlx_vlm import load; load('mlx-community/Qwen3.5-9B-MLX-4bit')\""
echo ""
echo "  # Image Generation"
echo "  python -c \"from mflux import Flux1; Flux1('flux2-klein-4b', quantize=4)\""
echo ""
